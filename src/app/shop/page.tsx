                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative aspect-[3/4] w-full overflow-hidden bg-white">
                        ...
                        <div className="absolute top-3 left-3 flex flex-col gap-1">
                          {product.isNewArrival && (
                            <span className="bg-[#1A1A1A] text-[#C6A664] text-[9px] uppercase font-bold px-2 py-0.5 rounded tracking-wider">
                              New Arrival
                            </span>
                          )}
                          {product.isBestSeller && (
                            <span className="bg-[#C6A664] text-black text-[9px] uppercase font-bold px-2 py-0.5 rounded tracking-wider">
                              Best Seller
                            </span>
                          )}
                        </div>
                        ...
                        <button
                          ...
                          className="absolute top-3 right-3 p-2 bg-white/80 backdrop-blur-md rounded-full text-[#1A1A1A] hover:text-red-600 transition-colors shadow"
                        >
                          <Heart
                            className={`w-4 h-4 ${
                      ...
                      <div className="p-4 space-y-2">
                        ...
                        {/* Multi-Color Swatch Row matching European Atelier styling */}
