      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-white/10">
          ...
          <div className="lg:col-span-1 space-y-4">
            <Link href="/" className="inline-block">
              <span className="font-serif text-2xl font-bold tracking-[0.2em] text-[#C6A664]">
                KHAVYN
              </span>
              <span className="block text-[9px] tracking-[0.25em] text-[#C6A664]/80 uppercase mt-0.5">
            ...
            <div className="flex items-center space-x-4 pt-2">
              ...
              <a
                href="https://linkedin.com/company/khavyn-fashion-pvt-ltd"
                target="_blank"
                rel="noreferrer"
          ...
          <div className="space-y-3">
            ...
            <form
              ...
              className="flex items-center border border-white/20 rounded overflow-hidden focus-within:border-[#C6A664]"
            >
              <input
                type="email"
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-white/50">
          <div className="space-y-1 text-center md:text-left">
            <p>© {new Date().getFullYear()} KHAVYN FASHION PRIVATE LIMITED. All Rights Reserved.</p>
            <p className="text-[11px] text-white/40">
              GST: 27AAMCK8767F1ZW | Registered Office: Samarth Nagar, New Sangavi, Pune – 411027, Maharashtra
            </p>
          </div>
